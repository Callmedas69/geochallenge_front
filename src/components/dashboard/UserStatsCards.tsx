    ...
    <>
      ...
      <Card className="border-l-4 border-l-blue-500">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-1">Total competitions</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-4 border-l-purple-500">
        ...
        <CardContent>
          <div className="text-3xl font-bold">{totalWon}</div>
      ...
      <Card className="border-l-4 border-l-yellow-500">
        ...
        <CardContent>
          <div className="text-3xl font-bold">{totalPrizesETH} ETH</div>
